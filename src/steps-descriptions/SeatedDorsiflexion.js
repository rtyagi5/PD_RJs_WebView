        ...
        <div className="max-w-2xl mx-auto p-5 bg-white rounded-2xl shadow-md space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                    A stable chair. Optional: use a resistance band around the foot for added resistance.
                </p>
            </div>
            ...
            <div className="bg-green-50 p-4 rounded-lg flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                    Sit tall on a chair with <span className="font-medium">feet flat on the floor</span>, knees at roughly 90 degrees. Keep your back straight and core engaged.
                </p>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                    Flex your foot upward (toward your shin) and then point it downward. Repeat for controlled repetitions.
                </p>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg flex flex-col gap-2">
                ...
                <ul className="space-y-2 text-sm text-gray-600 text-left">
                    ...
                    <li className="before:content-['•'] before:mr-2 before:text-purple-600">Optional: add a resistance band around the foot for added difficulty.</li>
                    <li className="before:content-['•'] before:mr-2 before:text-purple-600">Ensure the chair is stable and placed on a non-slippery surface.</li>
                </ul>
            </div>
        </div>
    );
